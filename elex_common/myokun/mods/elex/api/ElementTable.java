...
public class ElementTable {
    ...
    public static List tableMetalPlateUnlocList;
     ...
     * @param metalPlateUnlocList - A List to store the unlocalized names of your metal plates.
    ...
    public ElementTable(String name, String modid, int length, 
            ...
            List metalIngotUnlocalizedList, List metalNuggetUnlocalizedList, 
            List metalPlateUnlocList, IStorageBlockHandler metalStorageBlockListHandler, 
        ...
        this.tableMetalPlateUnlocList = metalPlateUnlocList;
