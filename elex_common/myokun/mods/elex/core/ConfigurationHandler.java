...
public class ConfigurationHandler {
    public static void mainConfig(File file) {
        ...
        ElexIDs.BLOCK_ELEX_ITEM_ORE_STORAGE_2 = config.getBlock(ElexIDs.CATEGORY_BLOCK_IDS, ElexIDs.BLOCK_ELEX_ITEM_ORE_STORAGE_2_KEY, ElexIDs.BLOCK_ELEX_ITEM_ORE_STORAGE_2_DEFAULT).getInt();
        ElexIDs.BLOCK_ELEX_ITEM_ORE_STORAGE_3 = config.getBlock(ElexIDs.CATEGORY_BLOCK_IDS, ElexIDs.BLOCK_ELEX_ITEM_ORE_STORAGE_3_KEY, ElexIDs.BLOCK_ELEX_ITEM_ORE_STORAGE_3_DEFAULT).getInt();
        ...
        ElexIDs.CONDENSATOR = config.getBlock(ElexIDs.CATEGORY_BLOCK_IDS, ElexIDs.CONDENSATOR_KEY, ElexIDs.CONDENSATOR_DEFAULT).getInt();
        ...
        ElexIDs.METAL_PLATE = config.getItem(ElexIDs.CATEGORY_ITEM_IDS, ElexIDs.METAL_PLATE_KEY, ElexIDs.METAL_PLATE_DEFAULT).getInt();
