...
public class ElexIDs {
    /* Block */
        ...
        public static final int ITEM_ELEX_ORE_DEFAULT = 3673;
        public static final int ITEM_ELEX_ORE_2_DEFAULT = 3674;
        public static final int ITEM_ELEX_ORE_3_DEFAULT = 3675;
        public static final int BLOCK_ELEX_ITEM_ORE_STORAGE_DEFAULT = 3676;
        public static final int BLOCK_ELEX_ITEM_ORE_STORAGE_2_DEFAULT = 3677;
        public static final int BLOCK_ELEX_ITEM_ORE_STORAGE_3_DEFAULT = 3678;
        public static final int BLOCK_ELEX_METAL_STORAGE_DEFAULT = 3679;
        public static final int BLOCK_ELEX_METAL_STORAGE_2_DEFAULT = 3680;
        public static final int BLOCK_ELEX_METAL_STORAGE_3_DEFAULT = 3681;
        public static final int BLOCK_ELEX_METAL_STORAGE_4_DEFAULT = 3682;
        public static final int BLOCK_ELEX_METAL_STORAGE_5_DEFAULT = 3683;
        public static final int BLOCK_ELEX_METAL_STORAGE_6_DEFAULT = 3684;
        public static final int BLOCK_ALLOY_STORAGE_DEFAULT = 3685;
    ...
    /* Item */
        ...
        public static final int METAL_PLATE_DEFAULT = 16246;
        public static final int SALTED_BEEF_DEFAULT = 16247;
        public static final int SALTED_CHICKEN_DEFAULT = 16248;
        public static final int SALTED_PORK_DEFAULT = 16249;
        public static final int SALTED_FISH_DEFAULT = 16250;
        ...
        public static final String METAL_PLATE_KEY = "METALPLATES";
        ...
        public static final String[] GEM_PLATE_UNLOCALIZED_NAMES = 
        	{ "plateEmerald", "plateLapis", "plateQuartz",
        	"plateAquamarine", "plateBorax", "plateFluorite", 
        	"plateForsterite", "platePetalite", "plateArtificialQuartz",
        	"plateSpodumene", "plateHalite", "plateRuby",
        	"plateSapphire", "plateUvarovite", "plateTsavorite",
        	"plateTurquoise", "plateGalena", "plateSylvite",
        	"plateGypsum", "plateThortveitite", "plateAnatase",
        	"plateBrookite", "plateVanadinite", "platePyrolusite",
        	"plateErythrite", "plateSphalerite", "plateGallite",
        	"plateGermanite", "plateMarthozite", "plateBromite",
        	"plateCelestine", "plateXenotime", "plateBaddeleyite",
        	"plateColumbite", "platePezzottaite", "plateBenitoite",
        	"plateMonazite", "plateEuxenite", "plateHafnon",
        	"plateTungstate", "plateRheniite", "plateCinnabar",
        	"plateHutchinsonite", "plateThorianite", "plateUraninite" };
        public static final List<String> METAL_PLATE_UNLOCALIZED_NAMES = new LinkedList<String>();
