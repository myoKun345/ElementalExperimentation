...
public class BlockElExOre2 extends Block {
    ...
    public void registerIcons(IconRegister register) {
        icons = new Icon[ElexIDs.BLOCK_ELEX_ORE_2_REAL_UNLOCALIZED_NAMES.length];
        for (int i = 0; i < icons.length; i++) {
            icons[i] = register.registerIcon(Reference.MOD_ID + ":" + ElexIDs.BLOCK_ELEX_ORE_2_REAL_UNLOCALIZED_NAMES[i]);
        }
    }
